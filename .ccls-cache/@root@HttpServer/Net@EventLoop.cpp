...
void EventLoop::addTimer(int timeout, const TimerWheel::Callback& cb, Timer::TimerType timertype) {
	std::shared_ptr<Timer> timer = std::make_shared<Timer>(timeout, timertype, cb);
